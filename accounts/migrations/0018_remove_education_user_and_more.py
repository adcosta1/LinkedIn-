...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0017_alter_linkedinuser_state'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='education',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.education'),
        ),
        migrations.AddField(
            model_name='linkedinuser',
            name='experience',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.professionalexperience'),
        ),
        migrations.AddField(
            model_name='professionalexperience',
            name='userid',
